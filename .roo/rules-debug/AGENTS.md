...
- **Schema version** is at [`database.dart:46`](lib/core/database/database.dart:46) — currently **16**
...
- **`avoid_print` lint** is noted in analysis_options.yaml — use `debugPrint` instead
